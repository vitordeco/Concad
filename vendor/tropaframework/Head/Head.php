...
fbq('init', '" . $id . "');";
	...
	public function addCalendar()
	{
		...
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.datepicker/jquery-ui.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.datepicker/init.js', 'text/javascript');
	}
	...
	public function addCarousel()
	{
		...
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.owl.carousel/owl.carousel.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.owl.carousel/init.js', 'text/javascript');
	}
	
	public function addCountdown()
	{
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.countdown/jquery.countdown.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.countdown/init.js', 'text/javascript');
	}
	...
	public function addFancybox()
	{
		...
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.fancybox/jquery.fancybox.pack.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.fancybox/init.js', 'text/javascript');
	}
	...
	public function addScroll()
	{
		...
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.perfect.scrollbar/js/perfect-scrollbar.jquery.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.perfect.scrollbar/js/init.js', 'text/javascript');
	}
	...
	public function addSelect2()
	{
		...
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.select2/js/select2.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.select2/js/init.js', 'text/javascript');
	}
	...
	public function addSlider()
	{
		...
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.nouislider/nouislider.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.nouislider/init.js', 'text/javascript');
	}
	
	public function addValidation()
	{
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.validation/jquery.validate.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.validation/additional-methods.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.validation/localization/messages_pt_BR.js', 'text/javascript');
	}
	
	public function addMask()
	{
		$js = $this->getServiceLocator->get('ViewHelperManager')->get('headScript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.mask/jquery.maskedinput.min.js', 'text/javascript');
		$js->appendFile('https://guerreiro.geofinder.tech/assets/application/js/extensions/jquery.mask/jquery.maskMoney.min.js', 'text/javascript');
	}
